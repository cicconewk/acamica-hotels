...
const hotelsData = [
  {
    ...
    photo: `${process.env.PUBLIC_URL}/assets/images/images/la-bamba-de-areco.jpg`,
    description:
    ...
    availabilityTo: today + 864000000, // 10 days
    rooms: 11,
    city: "Buenos Aires",
    country: "Argentina",
    price: 4,
  },
  {
    ...
    photo: `${process.env.PUBLIC_URL}/assets/images/images/sainte-jeanne.jpg`,
    description:
    ...
    availabilityFrom: today + 864000000, // 10 days
    availabilityTo: today + 1296000000, // 15 days
    rooms: 23,
    city: "Mar del Plata",
    country: "Argentina",
    price: 2,
  },
  {
    slug: "entre-cielos",
    name: "Entre Cielos",
    photo: `${process.env.PUBLIC_URL}/assets/images/images/entre-cielos.jpg`,
    description:
    ...
    availabilityFrom: today + 432000000, // 5 days
    availabilityTo: today + 1296000000, // 15 days
    rooms: 16,
    city: "Mendoza",
    country: "Argentina",
  ...
  },
  {
    ...
    photo: `${process.env.PUBLIC_URL}/assets/images/images/huacalera.jpg`,
    description:
    ...
    availabilityFrom: today + 1728000000, // 20 days
    availabilityTo: today + 2592000000, // 30 days
    rooms: 32,
    city: "Jujuy",
    country: "Argentina",
    price: 1,
  },
  {
    ...
    photo: `${process.env.PUBLIC_URL}/assets/images/images/merced-del-alto.jpg`,
    description:
    ...
    availabilityFrom: today,
    availabilityTo: today + 432000000, // 5 days
    rooms: 14,
    city: "Salta",
    country: "Argentina",
    price: 2,
  },
  {
    ...
    photo: `${process.env.PUBLIC_URL}/assets/images/images/azur-real.jpg`,
    description:
    ...
    availabilityFrom: today + 1296000000, // 15 days
    availabilityTo: today + 2592000000, // 30 days
    rooms: 16,
    city: "Córdoba",
    country: "Argentina",
  ...
  },
  {
    ...
    photo: `${process.env.PUBLIC_URL}/assets/images/images/rincon-del-socorro.jpg`,
    description:
  ...
  },
  {
    ...
    photo: `${process.env.PUBLIC_URL}/assets/images/images/luma-casa-de-montana.jpg`,
    description:
  ...
  },
  {
    slug: "casa-turquesa",
    name: "Casa Turquesa",
    photo: `${process.env.PUBLIC_URL}/assets/images/images/casa-turquesa.jpg`,
    description:
  ...
  },
  {
    slug: "vila-da-santa",
    name: "Vila Da Santa",
    photo: `${process.env.PUBLIC_URL}/assets/images/images/vila-da-santa.jpg`,
    description:
  ...
  },
  {
    ...
    photo: `${process.env.PUBLIC_URL}/assets/images/images/uxua-casa.jpg`,
    description:
  ...
  },
  {
    slug: "alto-atacama",
    name: "Alto Atacama",
    photo: `${process.env.PUBLIC_URL}/assets/images/images/alto-atacama.jpg`,
    description:
  ...
  },
  {
    ...
    photo: `${process.env.PUBLIC_URL}/assets/images/images/tierra-patagonia.jpg`,
    description:
    ...
    availabilityFrom: today + 2592000000, // 30 days
    availabilityTo: today + 3456000000, // 40 days
    rooms: 40,
  ...
  },
  {
    slug: "vira-vira",
    name: "Vira Vira",
    photo: `${process.env.PUBLIC_URL}/assets/images/images/vira-vira.jpg`,
    description:
    ...
    availabilityFrom: today + 864000000, // 10 days
    availabilityTo: today + 1728000000, // 20 days
    rooms: 21,
    city: "Pucón",
    country: "Chile",
    price: 4,
  },
  {
    slug: "vik-chile",
    name: "Vik Chile",
    photo: `${process.env.PUBLIC_URL}/assets/images/images/vik-chile.jpg`,
    description:
  ...
  },
  {
    slug: "casa-higueras",
    name: "Casa Higueras",
    photo: `${process.env.PUBLIC_URL}/assets/images/images/casa-higueras.jpg`,
    description:
  ...
  },
  {
    slug: "campo-tinto",
    name: "Campo Tinto",
    photo: `${process.env.PUBLIC_URL}/assets/images/images/campo-tinto.jpg`,
    description:
    ...
    availabilityFrom: today + 2160000000, // 25 days
    availabilityTo: today + 2592000000, // 30 days
    rooms: 4,
    city: "Colonia",
    country: "Uruguay",
